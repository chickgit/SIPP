                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="input-icon right">
                                                                        <i class="fa"></i>
                                                                        <input type="number" class="form-control" name="upd_sks_jw" readonly min="1" max="3" title="Mengikuti mata kuliah" /> 
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="input-icon right">
                                                                        <i class="fa"></i>
                                                                        <input type="number" class="form-control" name="upd_semester_jw" readonly min="1" max="8" title="Mengikuti mata kuliah" /> </div>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
...
jQuery(document).ready(function() {
    ...
    $('#generate_table_jadwal').on('click', function(){
        if (JADWAL > 0) 
        {
            ...
            form.validate({
                submitHandler: function (form) {
                    $.ajax({
                        url: "<?=base_url()?>jadwal_perkuliahan/generate", 
                        type: "POST",             
                        // data: {data : "ULANG"},
                        data: $(form).serialize(),
                        cache: false,             
    ...
    $('#sample_2').on('click', '#update_jw', function(){
        $.ajax({
            url: "<?=base_url()?>jadwal_perkuliahan/get_detail_jw", 
            type: "POST",
            dataType: "json",
        ...
        form4.validate({
            ...
            submitHandler: function (form) {
                ...
                $.ajax({
                    url: "<?=base_url()?>jadwal_perkuliahan/update_jw", 
                    type: "POST",             
                    data: $(form).serialize(),
                    cache: false,             
                    processData: false,      
    ...
    $('#sample_2').on('click', '#delete_jw', function(){
        ...
        form4.validate({
            submitHandler: function (form) {
                $.ajax({
                    url: "<?=base_url()?>jadwal_perkuliahan/delete_jw", 
                    type: "POST",
                    data: $(form).serialize(),
                    cache: false,             
                    processData: false,      
