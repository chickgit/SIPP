                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">List Mata Kuliah</span>
                                    </div>
                                    <div class="actions">
                                        ...
                                        <div class="modal-dialog modal-lg" id="modal_dialog_ambil_mk"> 
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">Ambil Mata Kuliah</h4>
                                                </div>
                                                <form id="form_ambil_mk" class="form-horizontal">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <input type="hidden" name="tahun_ajaran" value="<?=$tahun_ajaran->tahun_ajaran?>">
    ...
    $('#ambil_mk').on('click', function(){
        ...
        form4.validate({
            ...
            submitHandler: function (form) {
                ...
                {
                    $.ajax({
                        url: "<?=base_url()?>ambil_matakuliah/insert", 
                        type: "POST",             
                        data: $(form).serialize(),
                        cache: false,             
                        processData: false,      
