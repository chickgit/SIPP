                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="input-icon right">
                                                                        <i class="fa"></i>
                                                                        <input type="text" class="form-control" name="restore_nid" disabled /> </div>
                                                                        <input type="hidden" name="restore_nid">
                                                                        <input type="hidden" name="restore_table" value="dosen">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
    ...
    $('a#restore_dosen').on('click', function(){
        $.ajax({
            ...
            success: function(data) {
                // success4.show();
                $('input[name="restore_nid"]').val(data.nid);
