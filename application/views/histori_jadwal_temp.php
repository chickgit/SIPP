                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <div class="portlet-body">
                                                    ...
                                                    <td>
                                                        <div class="btn-group" style="position: relative;">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu" style="position: inherit;">
                                                                <li>
                                                                    <a id="restore_jadwal_temp" data-val="<?=$row->id_j_t?>">
                                                                        <i class="icon-docs"></i> Kembalikan </a>
                                                                </li>
                                                                <li>
                                                                    <a id="delete_jadwal_temp" data-val="<?=$row->id_j_t?>">
                                    ...
                                    <!-- MODAL DELETE -->
                                    <div class="modal fade " id="modal_restore_jadwal_temp" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog " id="modal_dialog_jadwal_temp"> 
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                    <h4 class="modal-title">Mengembalikan Dosen</h4>
                                                </div>
                                                <form id="form_restore_jadwal_temp" class="form-horizontal">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <input type="hidden" name="restore_1" value="id_j_t">
                                                        <input type="hidden" name="restore_2" value="jadwal_temp">
                                    ...
                                    <!-- MODAL DELETE -->
                                    <div class="modal fade " id="modal_delete_jadwal_temp" tabindex="-1" role="dialog" aria-hidden="true">
                                        <div class="modal-dialog " id="modal_dialog_jadwal_temp"> 
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                ...
                                                <form id="form_delete_jadwal_temp" class="form-horizontal">
                                                    <div class="modal-body"> 
                                                        <!-- BEGIN FORM-->
                                                        <div class="form-body">
                                                            <div class="alert alert-danger display-block">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <input type="hidden" name="delete_1" value="id_j_t">
                                                        <input type="hidden" name="delete_2" value="jadwal_temp">
                                                        <button type="button" class="btn dark btn-outline" data-dismiss="modal">Tutup</button>
...
jQuery(document).ready(function() {
    $('#sample_2').on('click', '#restore_jadwal_temp', function(){
        $.ajax({
            url: "<?=base_url()?>histori/jadwal_temp/get_data", 
            type: "POST",
            dataType: "json",
            data: {
                0 : 'jadwal_temp', 
                1 : {
                    id_j_t : $(this).data('val')
                }
            },
            beforeSend: function(){
                App.blockUI({
            ...
            success: function(data) {
                // success4.show();
                $('input[name="restore_0"]').val(data.id_j_t);
                ...
                $('#modal_restore_jadwal_temp').modal('show');
                console.log(data);
            },
            complete: function(){
                App.unblockUI();
        ...
        var form4 = $('#form_restore_jadwal_temp');
        var success4 = $('.alert-danger-delete', form4);

        form4.validate({
            submitHandler: function (form) {
                $.ajax({
                    url: "<?=base_url()?>histori/jadwal_temp/restore_data", 
                    type: "POST",
                    data: $(form).serialize(),
                    cache: false,             
                    processData: false,      
    ...
    $('#sample_2').on('click', '#delete_jadwal_temp', function(){
        $.ajax({
            url: "<?=base_url()?>histori/jadwal_temp/get_data", 
            type: "POST",
            dataType: "json",
            ...
            success: function(data) {
                // success4.show();
                $('input[name="delete_0"]').val(data.id_j_t);
                ...
                $('#modal_delete_jadwal_temp').modal('show');
                console.log(data);
            },
            complete: function(){
                App.unblockUI();
        ...
        var form4 = $('#form_delete_jadwal_temp');
        var success4 = $('.alert-danger-delete', form4);

        form4.validate({
            submitHandler: function (form) {
                $.ajax({
                    url: "<?=base_url()?>histori/jadwal_temp/delete_data", 
                    type: "POST",
                    data: $(form).serialize(),
                    cache: false,             
                    processData: false,      
